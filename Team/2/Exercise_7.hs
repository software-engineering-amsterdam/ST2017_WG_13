...
-- Tests:
-- First that it works: 
prop_validateIbansfromList::Property
prop_validateIbansfromList = forAll validIbanIndexes validIbansValidatedProperty

-- And Now that it does not incorrectly work:
prop_invalidIbansfromList::Property        
prop_invalidIbansfromList = forAll indexAndOffset changedCheckNumIsInvalid
