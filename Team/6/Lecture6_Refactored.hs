{-
  ...
  !
  ---------------------------------------------------------------------
  Important notice to Team and reviewers
  ---------------------------------------------------------------------
  !
  !
  Below is the orginal code for "Lecture6.hs" where
  
  exM is replaced by the exM implementation from Exercise_1
  
  see line 133
  ==============
  
  Therefore the other exercises can include Lecture6_Refactored
  
  and use the *much* faster implementation of ExM
  
-}



module Lecture6_Refactored where
