...
Finally, to get a list of a random size, we use `take` and  the randomly generated length on the the randomly generated infinite list.  This list then has  `list2set` applied to it .
